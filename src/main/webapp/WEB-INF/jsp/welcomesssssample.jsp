...
-->
    ...
    <link rel="stylesheet" href="/font-awesome.min.css">           <!-- Font Awesome, http://fontawesome.io/ -->
    <link rel="stylesheet" type="text/css" href="/bootstrap.min.css">                                 <!-- Bootstrap style, http://v4-alpha.getbootstrap.com/ -->
    <link rel="stylesheet" href="/magnific-popup.css">                                <!-- Magnific pop up style, http://dimsemenov.com/plugins/magnific-popup/ -->
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">
                    ...
                    <div class="tm-content-box tm-content-box-home">
                        <img src="/1200x800-01.jpg" alt="Image 1" class="img-fluid tm-welcome-img">
                    ...
                    <div id="gallery" class="tm-content-box">
                        <div class="grid tm-gallery">
                            <figure class="effect-bubba">
                                ...
                                <figcaption>
                                <img src="/img-11-08.jpg" action="findbyFullname" type="submit" class="img-fluid" >
                                    <h2> Find <span>Details</span></h2>
                                    <p>Find Details by Name</p>
                                    <a href="/img-11-08.jpg">View more</a>
                            ...
                            <figure class="effect-bubba">
                                <img src="/img-11-07.jpg" alt="Image 7" class="img-fluid">
                                <figcaption>
                                    <h2>Glass <span>Tower</span></h2>
                                    <p>Sed ut ipsum eu purus ullamcorper</p>
                                    <a href="/img-11-07.jpg">View more</a>
                                </figcaption>
                            </figure>

                            <figure class="effect-bubba">
                                <img src="/img-11-05.jpg" alt="Image 5" class="img-fluid">
                                <figcaption>
                                    <h2>Jump <span>Higher</span></h2>
                                    <p>Morbi fermentum eget libero sed</p>
                                    <a href="/img-11-05.jpg">View more</a>
                                </figcaption>
                            </figure>

                            <figure class="effect-bubba">
                                <img src="/img-11-03.jpg" alt="Image 3" class="img-fluid">
                                <figcaption>
                                    <h2>Forest <span>Park</span></h2>
                                    <p>Aenean rutrum enim a tellus suscipit</p>
                                    <a href="/img-11-03.jpg">View more</a>
                                </figcaption>
                            </figure>

                            <figure class="effect-bubba">
                                <img src="/img-11-02.jpg" alt="Image 2" class="img-fluid">
                                <figcaption>
                            ...
                            <figure class="effect-bubba">
                                <img src="/img-11-04.jpg" alt="Image 4" class="img-fluid">
                                <figcaption>
                    ...
                    <div id="services" class="tm-content-box tm-gray-bg tm-services">
                        ...
                        <div class="tm-services-img-container">
                            <img src="/450x900-01.jpg" alt="Green Field" class="img-fluid tm-services-img">
                        </div>
                        ...
                        <div class="tm-flex">
                            <div class="tm-contact-left-half tm-gray-bg">
                                <div class="tm-contact-inner-pad">
                                    ...
                                    <form action="findbyFullname" method="get" class="contact-form">
        ...
        <script src="/jquery.magnific-popup.min.js"></script>     <!-- Magnific pop-up (http://dimsemenov.com/plugins/magnific-popup/) -->
        <script src="/jquery.singlePageNav.min.js"></script>      <!-- Single Page Nav (https://github.com/ChrisWojcik/single-page-nav) -->
